...
replace (
	github.com/ValentinLutz/monrepo/libraries/api-helper v0.0.0 => ../../../libraries/api-helper
	github.com/ValentinLutz/monrepo/libraries/errors v0.0.0 => ../../../libraries/errors
)
